...
function T004_buildDimensionLayer(cfg, t) {
  ...
  return '  <g id="layer-dimensions">' +
    line(tx(312.704), ty(825), tx(681.208), ty(825), 'W ' + cfg.W + 'mm') +
    line(tx(681.208), ty(825), tx(865.46), ty(825), 'D ' + cfg.D + 'mm') +
    vline(tx(577.942), ty(458.925), ty(997.507), 'H ' + cfg.H + 'mm') +
    '</g>\n';
}
